...
export default function ModulesTable() {
  ...
  const features = {
    ES: [
      ...
      { name: "Configuración Adicional", lite: false, premium: true, tierra: false },
      { name: "Documentos", lite: true, premium: true, tierra: false },
      { name: "Email Canvas", lite: false, premium: true, tierra: false },
      { name: "Objetivos", lite: false, premium: true, tierra: false },
      { name: "Manejo de Estados", lite: false, premium: true, tierra: false },
      { name: "Manejo de Tablas", lite: false, premium: true, tierra: false },
      { name: "Kanban de Proyectos", lite: false, premium: true, tierra: false },
      { name: "Mejoras de Gestión de Proyectos", lite: false, premium: true, tierra: false },
      { name: "Recordatorio", lite: true, premium: true, tierra: false },
      { name: "Hojas de Cálculo en Línea", lite: false, premium: true, tierra: false },
    ...
    EN: [
      ...
      { name: "Proposals", lite: "Unlimited", premium: "Unlimited", tierra: false },
      { name: "Projects", lite: "5", premium: "20", tierra: true },
      { name: "Tasks", lite: "100", premium: "200", tierra: false },
      { name: "Support Tickets", lite: false, premium: "Unlimited", tierra: "5" },
      { name: "Leads", lite: "Unlimited", premium: "Unlimited", tierra: true },
      { name: "Products", lite: "30", premium: "Unlimited", tierra: false },
      { name: "Storage", lite: "1GB", premium: "10GB", tierra: "100GB" },
      { name: "CRM", lite: false, premium: false, tierra: true },
      { name: "Appointments", lite: false, premium: true, tierra: true },
      ...
      { name: "Additional Configuration", lite: false, premium: true, tierra: false },
      { name: "Documents", lite: true, premium: true, tierra: false },
      { name: "Email Canvas", lite: false, premium: true, tierra: false },
      { name: "Goals", lite: false, premium: true, tierra: false },
      { name: "State Management", lite: false, premium: true, tierra: false },
      { name: "Table Management", lite: false, premium: true, tierra: false },
      { name: "Project Kanban", lite: false, premium: true, tierra: false },
      { name: "Project Management Enhancements", lite: false, premium: true, tierra: false },
      { name: "Reminder", lite: true, premium: true, tierra: false },
      { name: "Online Spreadsheets", lite: false, premium: true, tierra: false },
